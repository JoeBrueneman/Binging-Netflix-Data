...
function infoBox(sample){
    d3.json(url).then(function(data){
        for (var i = 0;i < data.length; i++) {
            ...
            console.log(data[i].Hours_Viewed);
            console.log(data[i].Available_Globally);
            console.log(data[i].titleType);
            console.log(data[i].averageRating);
            console.log(data[i].numVotes);
